...
public class Controller : MonoBehaviour {
    ...
    //        print("ln_"+ln);// debug
    //        pos = this.transform.FindChild("SpawnPoints").FindChild(ln).transform; //assign the spawn position
    ...
    //        print("rn_"+rn);// debug
    //        pos = this.transform.FindChild("SpawnPoints").FindChild(rn).transform;
    ...
    //        if (rn=="spawn0"){rn="spawn";}
    //        print("fn_"+fn);// debug
    //        pos = this.transform.FindChild("SpawnPoints").FindChild(fn).transform;
